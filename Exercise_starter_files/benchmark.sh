...
# Total:        114  160  28.0    172     199#
 ...
 ab -n 10 -v 4 -p data.json -T 'application/json' -H 'Authorization: Bearer REPLACE_WITH_KEY' http://1a41de28-2bb1-476c-8c6f-6ffda2119593.southcentralus.azurecontainer.io/score
